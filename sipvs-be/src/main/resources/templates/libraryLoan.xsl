            ...
            <body>
                <form action="welcome.jsp"  method="post"
                    ...
                    <table>
                        ...
                        <tr><td>Librarian ID</td><td><input type="number" disabled="disabled">
                            <xsl:attribute name="value"><xsl:value-of select="l:librarianId" /></xsl:attribute>
                        </input></td></tr>
                        <tr><td>Borrower Card Number</td><td><input type="text" disabled="disabled">
                            <xsl:attribute name="value"><xsl:value-of select="l:borrower/l:cardNumber" /></xsl:attribute>
                        </input></td></tr>
                        <tr><td>Date Of Loan</td><td><input type="date" disabled="disabled">
                            <xsl:attribute name="value"><xsl:value-of select="l:dateOfLoan" /></xsl:attribute>
                        </input></td></tr>
