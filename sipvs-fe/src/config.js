...
(function () {
  ...
  ditec.config.dSigXadesJs = {
    ...
    "dlauncher2.urlList": [
      ...
      URL_BASE2 +
        "dsigner_2.x/sk.ditec.ep.products.dsigner.java.xml#action=dbridge",
    ],
    platforms: null,
  };
  ...
  ditec.config.dViewerJs = {
    ...
    "dlauncher2.urlList": [
      ...
      URL_BASE2 +
        "dviewer_2.x/sk.ditec.ep.products.dviewer.java.xml#action=dbridge",
    ],
    platforms: null,
  };
  ...
  ditec.config.dSigXadesExtenderJs = {
    ...
    "dlauncher2.urlList": [
      ...
      URL_BASE2 +
        "extender_2.x/sk.ditec.ep.products.dsignertools.java.xml#action=dbridge",
    ],
    platforms: null,
  };
  ...
  ditec.config.dGinaJs = {
    ...
    "dlauncher2.urlList": [
      ...
      URL_BASE2 +
        "dgina_2.x/sk.ditec.ep.products.dgina.java.xml#action=dbridge",
    ],
    platforms: null,
  };
